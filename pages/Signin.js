...
return (
    ...
    {/* logo */}
      ...
      {/* sign-in form */}
    <div className='border p-2 w-[380px] justify-self-center pl-2 pr-2 -mt-[20px]'>
        ...
        <button onClick={!session ? signIn : signOut} className='bg-black text-white w-[360px] h-[35px] hover:bg-white hover:text-black mt-3 rounded-md'>{session ? "Sign out of Amazon Clone" : "Sign-in with Google"}</button>
