...
function EmptyCart() {
  ...
  return (
    <div>
      <div className ="block lg:flex md:flex   bg-white mt-0 mb-2 my-2 md:mx-0 md:my-5  lg:ml-4 lg:mr-0 lg:my-5 p:2 lg:p-3 md:p-3  space-x-0 md:space-x-20 lg:space-x-20 w-full md:w-full lg:w-[1150px]">
            ...
            <div className = " bg-white mx-0 mt-0 mb-4 md:mx-0 md:my-5 lg:ml-4 lg:mr-0 lg:my-5 p-3 w-full md:w-full lg:w-[1150px]">
            <button onClick={()=>router.push("/All_products")} className = {`inline-block md:hidden lg:hidden bg-yellow-400  rounded-md w-full mb-3 lg:w-[300px] md:w-[300px] pt-3 p-2 md:p-10 lg:p-10`}>Shop now !</button>

            </div>

            <p className ="  hidden lg:inline-block md:inline-block text-xs mb-5 w-full md:w-full lg:w-[1150px] ml-5 mr-3 lg:ml-4 lg:mr-0 md:ml-0 md:mr-0 p-2">The price and availability of items at Amazon.com are subject to change. The Cart is a temporary place to store a list of your items and reflects each item's most recent price. Shopping Cart <span className = "text-blue-500 hover:text-red hover:underline cursor-pointer"> Learn more </span>
