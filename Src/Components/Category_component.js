...
function Category_component() {
  return (
    <div className='space-y-3 ml-2 mr-2 -mt-[10px] lg:mt-[-320px] md:-mt-[180px]  '>
         <div className='hidden lg:flex md:flex z-30 space-x-3 whitespace-nowrap overflow-x-scroll scrollbar-hide'>
      ...
      <div className='p-1  w-[400px] z-30 lg:h-[400px] md:h-[400px] sm:h-[50] space-y-7 flex-shrink'>
