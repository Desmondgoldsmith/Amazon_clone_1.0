  ...
  return (
    <header>
      <div className='bg-[rgb(26,33,45)] flex p-1 items-center flex-grow'>
       ...
       <div onClick={()=>router('/')} className='mt-2 items-center flex-grow sm:flex-grow-0 hover:border border border-transparent p-1 hover:border-solid hover:border-white cursor-pointer'>
