...
{/* second nav */}
      ...
      <div className='lg:bg-amazon_blue-light pb-2 md:bg-amazon_blue-light bg-amazon_blue lg:h-9 md:h-9 sm:h-20  text-white '>
        {/* search bar */}
      ...
      <div className='pr-2 p-1 hover:border text-base border-white lg:float-right'>
