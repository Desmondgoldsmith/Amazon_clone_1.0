...
{/* second nav */}
      ...
      <div className='lg:bg-amazon_blue-light md:bg-amazon_blue-light bg-amazon_blue lg:h-9 md:h-9 sm:h-20  text-white '>
        {/* search bar */}
      ...
      <div className='pr-2 p-1 hover:border border-white lg:ml-[600px]'>
        <p className='text-sm'>Turn up the cheer, shop gifts now</p>
      </div>
      </div>
      </div>
      {/* visible on small screens */}
      <div className='bg-amazon_blue-light h-20 p-2'>
        <div className='lg:hidden sm:flex md:hidden flex flex-row  text-white ml-2 mr-2 hover:border border border-transparent p-1 hover:border-solid hover:border-white cursor-pointer'>
