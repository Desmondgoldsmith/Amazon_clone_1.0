...
function EmptyCart() {
  ...
  return (
    <div>
      <div className ="block lg:flex md:flex   bg-white mx-0 my-2 md:mx-0 md:my-5  lg:mx-0 lg:my-5 p:2 lg:p-3 md:p-3  space-x-0 md:space-x-20 lg:space-x-20 w-full md:w-full lg:w-[1150px]">
            ...
            <button onClick={()=>router.push("/All_products")} className = {`bg-yellow-400 p-2 rounded-md w-full mb-3 lg:w-[300px] md:w-[300px] pt-3`}>Shop now !</button>
