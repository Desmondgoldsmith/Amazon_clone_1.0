...
function Signin() {
  return (
    ...
    <div className='border w-[400px] justify-self-center pl-3 pr-3'>
        ...
        <button className='bg-[rgb(240,197,97)] hover:bg-yellow-500 w-[370px] h-[35px] mt-3 rounded-md'>Continue</button>
        <button className='bg-white w-[370px] h-[35px] hover:bg-black hover:text-white mt-3 rounded-md'>Sign-in with Google</button>
