      ...
      <div className = "flex mt-5">
       <div className="w-[300px] border-2 border-red-600 p-1">
        ...
        <p className='text-[16px] font-extrabold'>Customer Reviews</p>
         <p className = "cursor-pointer text-[13px]"><Link href="/#">Women's Fashion</Link> </p>
         <p className = "cursor-pointer text-[13px]"><Link href="/#">Women's Shoes</Link> </p>
        <p className = "cursor-pointer text-[13px]"><Link href="/#"> Women's Clothing</Link></p>
